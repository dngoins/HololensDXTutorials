...
namespace RemotingHostSample
{
    ...
    public:
        ...
        void Tick();
		Platform::String ^ GetModelFileName() { return m_modelFileName; }
		void SetModelFileName(Platform::String ^ fileName, bool useRelativePath = true) { m_modelFileName = fileName; m_useRelativePath = useRelativePath; }
		void Reset();
