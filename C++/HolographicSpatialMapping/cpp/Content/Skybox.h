...
namespace WindowsHolographicCodeSamples
{
    ...
    {
    public:
        Skybox(const std::shared_ptr<DX::DeviceResources>& deviceResources, float scale);
    ...
    private:
        ...
        double                                          m_maxTrianglesPerCubicMeter = 1200.00;
		...
		CBufferPerObject	mVertexCBufferPerObjectData;
    };
};
