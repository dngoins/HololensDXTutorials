...
#include "Common\hlDeviceResources.h"
#include "Common\DeviceResourcesWindowed.h"
#include "Common\hlStepTimer.h"
...
namespace App1
{
	...
	{
	public:
		ModelRenderer(const std::shared_ptr<hlDX::DeviceResources>& deviceResources, const std::wstring& filename, bool useRelativePath);
		void CreateWindowSizeDependentResources();
		void CreateDeviceDependentResources();
		void ReleaseDeviceDependentResources();
		void Update(const hlDX::StepTimer& timer);
	...
	private:
		...
		std::shared_ptr<hlDX::DeviceResources>            m_deviceResources;
		...
		// Mesh::ModelConstantBuffer                             m_modelConstantBufferData;
